...
contract Domains is ERC721URIStorage {
  ...
  // Keep a track of Distributed Token Id's
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A Place on the Barkeepers Tab", "image": "data:image/svg+xml;base64,',
